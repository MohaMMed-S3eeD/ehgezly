          ...
          ? data.map((item, idx) => (
              <SwiperSlide key={item.id}>
                <Link href={`/services/${item.id}`} className="block">
                  <div className="group relative h-120 rounded-2xl overflow-hidden bg-background shadow-lg transition-transform duration-300 ease-out hover:scale-[1.02] hover:shadow-2xl">
